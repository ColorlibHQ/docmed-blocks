...
<h2 class="wp-block-heading has-text-align-center">We could not find that page</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center">The address may be old, or the page may have moved. Try a search, or start again from the home page.</p>
<!-- /wp:paragraph -->
