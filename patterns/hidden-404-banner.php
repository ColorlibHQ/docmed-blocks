...
<div class="wp-block-group"><!-- wp:heading {"level":1,"textColor":"overlay"} -->
<h1 class="wp-block-heading has-overlay-color has-text-color">Page not found</h1>
<!-- /wp:heading -->
