 ...
 *
 *   WP_URL=https://example.com DOCMED_PATHS=/,/contact/ node .dev/overflow-check.mjs
 *
 * @package Docmed
 */
...
const paths = ( process.env.DOCMED_PATHS || '/,/departments/,/doctors/,/about/,/appointment/,/contact/,/blog/,/your-first-visit/,/category/physiotherapy/,/?s=clinic,/no-such-page/' ).split( ',' ).filter( Boolean );
const widths = ( process.env.DOCMED_WIDTHS || '1400,1024,768,390' ).split( ',' ).map( Number );
